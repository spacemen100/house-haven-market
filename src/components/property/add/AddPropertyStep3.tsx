...
const AddPropertyStep3 = ({ onBack, onNext, initialData }: AddPropertyStep3Props) => {
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      has_internet: initialData?.has_internet || (initialData as any)?.hasInternet || false,
      has_cable_tv: initialData?.has_cable_tv || (initialData as any)?.hasCableTv || false,
      has_satellite_tv: initialData?.has_satellite_tv || (initialData as any)?.hasSatelliteTv || false,
      has_phone_line: initialData?.has_phone_line || (initialData as any)?.hasPhoneLine || false,
      ...
      has_washing_machine: initialData?.has_washing_machine || (initialData as any)?.hasWashingMachine || false,
      has_tv: initialData?.has_tv || (initialData as any)?.hasTv || false,
      has_coffee_machine: initialData?.has_coffee_machine || (initialData as any)?.hasCoffeeMachine || false,
      has_audio_system: initialData?.has_audio_system || (initialData as any)?.hasAudioSystem || false,
      has_heater: initialData?.has_heater || (initialData as any)?.hasHeater || false,
      has_hair_dryer: initialData?.has_hair_dryer || (initialData as any)?.hasHairDryer || false,
      has_refrigerator: initialData?.has_refrigerator || (initialData as any)?.hasRefrigerator || false,
      has_vacuum_cleaner: initialData?.has_vacuum_cleaner || (initialData as any)?.hasVacuumCleaner || false,
      has_dryer: initialData?.has_dryer || (initialData as any)?.hasDryer || false,
      has_iron: initialData?.has_iron || (initialData as any)?.hasIron || false,
