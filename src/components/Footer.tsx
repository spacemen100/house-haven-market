      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/sell" className="text-estate-neutral-200 hover:text-teal-500">Sell or save a new ad</Link>
              </li>
              <li>
                <Link to="/properties?type=rent_by_day" className="text-estate-neutral-200 hover:text-teal-500">Daily Rent</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-estate-neutral-300 text-sm">
            © 2025 Houseსახლი. All rights reserved.
          </p>
